"""Repo-specific configuration for stock-sent-analyst."""
...
def get_poller_name() -> str:
    ...
    return get_config_value("POLLER_NAME", "stock_sent_analyst")


def get_rabbitmq_queue() -> str:
    """Return the RabbitMQ queue name for this poller."""
    return get_config_value("RABBITMQ_QUEUE", "stock_sent_analyst_queue")


def get_dlq_name() -> str:
    """Return the Dead Letter Queue (DLQ) name for this poller."""
    return get_config_value("DLQ_NAME", "stock_sent_analyst_dlq")
